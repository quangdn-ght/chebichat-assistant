...
export function ChatActions(props: {
  ...
  const models = useMemo(() => {
    // Only show specific Qwen models: qwen-turbo, qwen-max, qwen-vl-plus
    ...
    const filteredModels = allModels.filter(
      (m) => m.available && allowedModelNames.includes(m.name),
    );

    // Comment out original logic that shows all models
